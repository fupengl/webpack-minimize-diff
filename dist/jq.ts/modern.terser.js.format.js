        ...
        !(function (t, n) {
              ...
              if (!i && (p(t), (t = t || d), g)) {
                ...
                if (n.qsa && !A[e + " "] && (!v || !v.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                  if (((y = e), (m = t), 1 === w && (U.test(e) || z.test(e)))) {
                    for (
                      ((m = (ee.test(e) && ye(t.parentNode)) || t) === t && n.scope) || ((c = t.getAttribute("id")) ? (c = c.replace(re, ie)) : t.setAttribute("id", (c = b))),
                        s = (h = a(e)).length;
                      s--;
          ...
          (E.filter = function (e, t, n) {
            ...
            E.fn.extend({
              ...
              is: function (e) {
                return !!L(this, "string" == typeof e && j.test(e) ? E(e) : e || [], !1).length;
              },
            });
          var H,
            O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
          ((E.fn.init = function (e, t, n) {
            ...
            if (((n = n || H), "string" == typeof e)) {
              ...
              if (r[1]) {
                if (((t = t instanceof E ? t[0] : t), E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), q.test(r[1]) && E.isPlainObject(t)))
                                ...
                                (l = r && ("object" == typeof r || "function" == typeof r) && r.then),
                                  y(l)
                                    ? i
                                      ...
                                      : (o++, l.call(r, a(o, t, W, i), a(o, t, F, i), a(o, t, W, t.notifyWith)))
                                    : (n !== W && ((s = void 0), (u = [r])), (i || t.resolveWith)(s, u));
                              }
                            },
                            c = i
                              ? l
                              : function () {
                                  try {
                                    ...
                                    E.Deferred.exceptionHook && E.Deferred.exceptionHook(r, c.stackTrace), e + 1 >= o && (n !== F && ((s = void 0), (u = [r])), t.rejectWith(s, u));
                                  }
                                };
          ...
          (E.fn.ready = function (e) {
            ...
            E.extend({
              ...
              readyWait: 1,
              ready: function (e) {
                (!0 === e ? --E.readyWait : E.isReady) || ((E.isReady = !0), (!0 !== e && --E.readyWait > 0) || _.resolveWith(x, [E]));
              },
            }),
            (E.ready.then = _.then),
          ...
          function de(e, t) {
            for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
              (r = e[o]).style &&
                ((n = r.style.display),
                t
                  ? ("none" === n && ((i[o] = K.get(r, "display") || null), i[o] || (r.style.display = "")), "" === r.style.display && le(r) && (i[o] = pe(r)))
          ...
          function Ce(e, t, n, r, i) {
            ...
            for (f.textContent = "", d = 0; (o = p[d++]); )
              ...
              else if (((l = se(o)), (a = be(f.appendChild(o), "script")), l && we(a), n)) for (c = 0; (o = a[c++]); ) me.test(o.type || "") && n.push(o);
            return f;
          }
          var Ee = /^([^.]*)(?:\.(.+)|)/;
          function Se() {
          ...
          (E.event = {
                ...
                for (
                  ...
                  (d = g = (s = Ee.exec(t[l]) || [])[1]),
                    ...
                    d &&
                      ...
                      (f = E.event.special[d] || {}),
                      (c = E.extend(
                        { type: d, origType: g, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && E.expr.match.needsContext.test(i), namespace: h.join(".") },
                        o
                      )),
            ...
            special: {
              ...
              click: {
                setup: function (e) {
                  var t = this || e;
                  return ve.test(t.type) && t.click && D(t, "input") && je(t, "click", Se), !1;
                },
                trigger: function (e) {
                  var t = this || e;
          ...
          function Ie(e, t, n, r) {
            ...
            if (p && ((o = (i = Ce(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = o), o || r)) {
              for (s = (a = E.map(be(i, "script"), Oe)).length; f < p; f++) (l = i), f !== d && ((l = E.clone(l, !0, !0)), s && E.merge(a, be(l, "script"))), n.call(e[f], l, f);
              if (s)
                for (c = a[a.length - 1].ownerDocument, E.map(a, Pe), f = 0; f < s; f++)
                  (l = a[f]),
                    me.test(l.type || "") &&
          ...
          E.extend({
            ...
            clone: function (e, t, n) {
              var r,
                ...
                s = e.cloneNode(!0),
                u = se(e);
              if (!(v.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || E.isXMLDoc(e))) for (a = be(s), r = 0, i = (o = be(e)).length; r < i; r++) Me(o[r], a[r]);
              if (t)
          ...
          function rt(e, t, n) {
            ...
            return (
              ((!v.boxSizingReliable() && i) || (!v.reliableTrDimensions() && D(e, "tr")) || "auto" === a || (!parseFloat(a) && "inline" === E.css(e, "display", !1, r))) &&
            ...
            (it.propHooks = {
              _default: {
                ...
                set: function (e) {
                  E.fx.step[e.prop]
                    ? E.fx.step[e.prop](e)
                    : 1 !== e.elem.nodeType || (!E.cssHooks[e.prop] && null == e.elem.style[Je(e.prop)])
                    ? (e.elem[e.prop] = e.now)
          ...
          var ot,
            ...
            ut = /queueHooks$/;
          function lt() {
            at && (!1 === x.hidden && r.requestAnimationFrame ? r.requestAnimationFrame(lt) : r.setTimeout(lt, E.fx.interval), E.fx.tick());
          }
          function ct() {
            return (
              r.setTimeout(function () {
          ...
          function dt(e, t, n) {
            ...
            for (
              ...
              if ((r = dt.prefilters[o].call(l, e, c, l.opts))) return y(r.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
            return (
              E.map(c, pt, l),
              ...
              function (e, t, n) {
                ...
                if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(d))
                  for (r in (f &&
                    ...
                    "none" === (c = E.css(e, "display")) && (l ? (c = l) : (de([e], !0), (l = e.style.display || l), (c = E.css(e, "display")), de([e]))),
                  ...
                  d))
                    u ||
                      ...
                      g && de([e], !0),
                      p.done(function () {
                        for (r in (g || de([e]), K.remove(e, "fxshow"), d)) E.style(e, r, d[r]);
                      })),
                      (u = pt(g ? v[r] : 0, r, p)),
              ...
              attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                  return void 0 === e.getAttribute
                    ? E.prop(e, t, n)
                    : ((1 === o && E.isXMLDoc(e)) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? ht : void 0)),
                      void 0 !== n
                        ? null === n
            ...
            E.fn.extend({
              addClass: function (e) {
                ...
                return y(e)
                  ...
                  : (t = bt(e)).length
                  ? this.each(function () {
                      if (((r = xt(this)), (n = 1 === this.nodeType && " " + mt(r) + " "))) {
              ...
              toggleClass: function (e, t) {
                ...
                return y(e)
                  ...
                  : ((n = bt(e)),
                    this.each(function () {
                      if (s) for (o = E(this), i = 0; i < n.length; i++) (r = n[i]), o.hasClass(r) ? o.removeClass(r) : o.addClass(r);
                      else
                        (void 0 !== e && "boolean" !== a) ||
                          ((r = xt(this)) && K.set(this, "__className__", r),
                          this.setAttribute && this.setAttribute("class", r || !1 === e ? "" : K.get(this, "__className__") || ""));
                    }));
              },
              hasClass: function (e) {
                var t,
              ...
              if (
                ...
                for (o = 0; (a = h[o++]) && !e.isPropagationStopped(); )
                  (p = a),
                    ...
                    (c = l && a[l]) && c.apply && Q(a) && ((e.result = c.apply(a, t)), !1 === e.result && e.preventDefault());
                return (
                  (e.type = g),
                  i ||
            ...
            E.fn.extend({
              ...
              serializeArray: function () {
                return this.map(function () {
                  ...
                  .filter(function () {
                    var e = this.type;
                    return this.name && !E(this).is(":disabled") && Dt.test(this.nodeName) && !jt.test(e) && (this.checked || !ve.test(e));
                  })
                  .map(function (e, t) {
                    var n = E(this).val();
                    return null == n
          ...
          ($t.href = Et.href),
            E.extend({
              ...
              ajax: function (e, t) {
                ...
                if ((d.data && d.processData && "string" != typeof d.data && (d.data = E.param(d.data, d.traditional)), _t(It, d, t, C), l)) return C;
                ...
                d.hasContent
                  ...
                  : ((p = d.url.slice(i.length)),
                    ...
                    !1 === d.cache && ((i = i.replace(Ot, "$1")), (p = (kt.test(i) ? "&" : "?") + "_=" + St.guid++ + p)),
                    (d.url = i + p)),
                d.ifModified && (E.lastModified[i] && C.setRequestHeader("If-Modified-Since", E.lastModified[i]), E.etag[i] && C.setRequestHeader("If-None-Match", E.etag[i])),
                ((d.data && d.hasContent && !1 !== d.contentType) || t.contentType) && C.setRequestHeader("Content-Type", d.contentType),
                C.setRequestHeader(
                  "Accept",
                  d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : d.accepts["*"]
                ),
                d.headers))
                  C.setRequestHeader(f, d.headers[f]);
                if (d.beforeSend && (!1 === d.beforeSend.call(h, C, d) || l)) return C.abort();
                if (((T = "abort"), y.add(d.complete), C.done(d.success), C.fail(d.error), (n = _t(Wt, d, t, C)))) {
                ...
                function S(e, t, a, u) {
                  ...
                  l ||
                    ...
                    f
                      ? (d.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (E.lastModified[i] = w), (w = C.getResponseHeader("etag")) && (E.etag[i] = w)),
                    ...
                    y.fireWith(h, [C, T]),
                    c && (g.trigger("ajaxComplete", [C, d]), --E.active || E.event.trigger("ajaxStop")));
                }
                return C;
              },
          ...
          E.ajaxSetup({
            ...
            E.ajaxPrefilter("json jsonp", function (e, t, n) {
              var i,
                ...
                s =
                  !1 !== e.jsonp &&
                  (Yt.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Yt.test(e.data) && "data");
              if (s || "jsonp" === e.dataTypes[0])
                return (
                  ...
                  n.always(function () {
                    void 0 === o ? E(r).removeProp(i) : (r[i] = o), e[i] && ((e.jsonpCallback = t.jsonpCallback), Gt.push(i)), a && y(o) && o(a[0]), (a = o = void 0);
                  }),
                  "script"
                );
            }),
            (v.createHTMLDocument = (((Vt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Vt.childNodes.length)),
            (E.parseHTML = function (e, t, n) {
              return "string" != typeof e
                ? []
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  t ||
                    (v.createHTMLDocument ? (((r = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href), t.head.appendChild(r)) : (t = x)),
                  (o = !n && []),
                  (i = q.exec(e)) ? [t.createElement(i[1])] : ((i = Ce([e], t, o)), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
              var r, i, o;
            }),
            ...
            E.each(["top", "left"], function (e, t) {
              E.cssHooks[t] = Ve(v.pixelPosition, function (e, n) {
                if (n) return (n = Xe(e, t)), Fe.test(n) ? E(e).position()[t] + "px" : n;
              });
            }),
          ...
          return (
            (E.noConflict = function (e) {
              return r.$ === E && (r.$ = Kt), e && r.jQuery === E && (r.jQuery = Jt), E;
            }),
